...
private:
  ...
  message_filters::Subscriber<leg_target_detector::LegArray> non_leg_clusters_sub_;
  message_filters::TimeSynchronizer<sensor_msgs::LaserScan, leg_target_detector::LegArray> sync;
  ...
  */
  void laserAndLegCallback(const sensor_msgs::LaserScan::ConstPtr& scan_msg, const leg_target_detector::LegArray::ConstPtr& non_leg_clusters)
  {
    ...
    if (transform_available)
    {
      ...
      {
        leg_target_detector::Leg leg = non_leg_clusters->legs[i];
